...
class _EnterPINState extends State<EnterPIN> {
  ...
  @override
  Widget build(BuildContext context) {
    // Get.put(InterfaceControllerImp());
    // return GetBuilder<InterfaceControllerImp>(
    //   builder: (controller) =>
    return Scaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  textAlign: TextAlign.center,
                  "Enter the 6-digit verfication code that was seht to your email or phone",
                  style: TextStyle(
                      color: Colors.grey,
                      fontSize: 15,
                      fontWeight: FontWeight.w500),
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:
                  List.generate(6, (index) => buildPinTextField(index)),
                ...
                child: Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        if (enteredPin.length == 6) {
                          ...
                          if (enteredPin == savedPin) {
                            ...
                            {
                              return AlertDialog(
                                title: Text("Check your email or phone"),
                                content: Text(
                                    "Enter your code that you take of email or phone."),
                                actions: [
                                  ElevatedButton(
                                    onPressed: () {
                                      // Close the dialog
                            ...
                            if (_attempts < _maxAttempts) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    "Incorrect Code. Please try again. Attempts: $_attempts",
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white, backgroundColor: Colori.mainblue,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8.0),
                        ),
                        elevation: 3.0,
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                  Text("Didn't recive Code Yet?",style: TextStyle(color: Colors.grey,fontSize: 15),),
                  TextButton(onPressed: (){}, child: Text("Resend",style: TextStyle(color: Colori.mainblue,fontSize: 15)))
                ],),
              )
            ],
          ),
